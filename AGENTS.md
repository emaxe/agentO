...
- **proxy-test** (`.agents/skills/proxy-test/SKILL.md`) — шаблон для тестирования прокси-серверов agento против реального API. Триггер: `/proxy-test` или задачи вида "протестируй прокси", "проверь провайдера через прокси".
